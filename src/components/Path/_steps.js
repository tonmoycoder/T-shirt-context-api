...
4. If needed you can use multiple context api(createContext)
and also you can receive context in different name but must be used in format like if it's array you need to receive  destructure as array
